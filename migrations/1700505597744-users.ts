...
export class Users1700505597744 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ALTER TABLE "users"
        ADD CONSTRAINT "FK_a6aa735704d3f00c6033c57f81f" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE
        SET NULL ON UPDATE CASCADE
    `);
    await queryRunner.query(`
        INSERT INTO "users" (name, role, created_by) VALUES ('ADMIN', 'admin', 1), ('MANAGER', 'manager', 1), ('EMPLOYEE', 'employee', 1)
    `);
  }
